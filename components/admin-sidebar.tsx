...
export function AdminSidebar() {
  ...
  <button
    ...
    className="group flex items-center w-full text-[17px] font-medium text-red-400 hover:text-red-500 hover:bg-red-100/20 rounded-lg px-4 py-2 transition-all duration-200 ease-in-out"
  >
    <LogOut className="mr-3 h-5 w-5 transition-transform duration-200 ease-in-out group-hover:-translate-x-1" />
    Sign out
  </button>
</div>
